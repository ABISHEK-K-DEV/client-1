...
const LogForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Direct URL (Replace the environment variable with the actual URL)
      const apiBaseUrl = "https://sever-gc0a.onrender.com"; // Direct URL

      await axios.post(`${apiBaseUrl}/api/events`, payload);
      alert("Event logged successfully!");
      setEventType("");
      setTimestamp("");
      setSourceAppId("");
